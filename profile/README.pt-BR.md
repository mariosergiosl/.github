...
# Mário Luz - Arquitetura de Sistemas & Forense Digital
...
Sou Engenheiro de Sistemas com mais de 25 anos de experiência na arquitetura de infraestruturas complexas de TI e atuo como **Perito Judicial Independente em Computação Forense e Forense Digital** nomeado pelo Tribunal de Justiça do Distrito Federal e Territórios (TJDFT).

Meu foco é solucionar desafios de arquitetura de alta disponibilidade e extrair dados fundamentais e irrefutáveis (*ground-truth data*) diretamente do kernel do sistema operacional, contornando as limitações impostas pelo *user-space*.

* 🔭 **Construindo atualmente:** [`sys-inspector`](https://github.com/mariosergiosl/sys-inspector) – uma ferramenta avançada de observabilidade e análise forense baseada em eBPF.
* 🏛️ **Forense:** Membro efetivo da APECOF (Associação Nacional dos Peritos em Computação Forense).
...
*Ferramenta eBPF para monitoramento em tempo real de processos e chamadas de sistema (syscalls) no Linux.*
