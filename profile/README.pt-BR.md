...
# Mário Luz - Arquitetura de Sistemas & Perícia Digital
...
![Forensics](https://img.shields.io/badge/Digital_Forensics-000000?style=for-the-badge&logo=security&logoColor=white)

## ⚙️ Sobre

Sou Engenheiro de Sistemas com mais de 25 anos de experiência na arquitetura de infraestruturas de TI complexas e **Perito Judicial Independente em Perícia Digital e Computação Forense** nomeado pelo Tribunal de Justiça do Distrito Federal e Territórios (TJDFT).

Meu foco é resolver desafios de arquitetura de alta disponibilidade e extrair dados fundamentais (*ground-truth*) diretamente do kernel do sistema operacional, contornando as limitações do *user-space*.

* 🔭 **Desenvolvendo atualmente:** [`sys-inspector`](https://github.com/mariosergiosl/sys-inspector) – uma ferramenta avançada de observabilidade e perícia forense baseada em eBPF.
* 🏛️ **Forense:** Membro ativo da APECOF (Associação Nacional dos Peritos em Computação Forense).
* 📡 **Telemetria:** [LinkedIn](https://www.linkedin.com/in/mariosergiosl/) | [Nordico Club](https://nordico.club) | [Lattes](http://lattes.cnpq.br/2504292559472109) | [ORCID](https://orcid.org/0009-0006-3750-1871)

## 🚀 Projetos em Destaque

### [Sys-Inspector](https://github.com/mariosergiosl/sys-inspector)

*Ferramenta eBPF para monitoramento em tempo real de processos e chamadas de sistema no Linux.*
...
*Guia completo para SaltStack v3007 no openSUSE Leap 15.6 com SSH/API.*
...
*Configurações para clusters K3s com Podman.*
...
---
*Construindo sistemas que escalam perfeitamente e revelando a verdade onde os outros veem apenas ruído.*
